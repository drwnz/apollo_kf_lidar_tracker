...
// ---------------------------------------------------------------------------
ApolloTracker::ApolloTracker(float in_time_delta,
...
void ApolloTracker::CreatePolygonFromPoints(const geometry_msgs::Polygon& in_points, boost_polygon& out_polygon)
{
...
void ApolloTracker::Update(const autoware_msgs::CloudClusterArray& in_cloud_cluster_array, DistType in_match_method)
{
...
void ApolloTracker::CheckTrackerMerge(size_t in_tracker_id, std::vector<CTrack>& in_trackers, std::vector<bool>& in_out_visited_trackers, std::vector<size_t>& out_merge_indices, double in_merge_threshold)
{
...
void ApolloTracker::MergeTrackers(std::vector<CTrack>& in_trackers, std::vector<CTrack>& out_trackers, std::vector<size_t> in_merge_indices, const size_t& current_index, std::vector<bool>& in_out_merged_trackers)
{
...
void ApolloTracker::CheckAllTrackersForMerge(std::vector<CTrack>& out_trackers)
{
...
ApolloTracker::~ApolloTracker(void)
{
}
